...
(function($) {
    ...
    $.fn.addTag = function(value, options) {
        ...
        this.each(function() {
            ...
            if (options.unique) {
                //至多五个标签，单个标签长度不超过10个字符
                var skipTag = $(this).tagExist(value) || value.length > 10 || tagslist.length > 4;
                if (skipTag == true) {
                ...
                if (value.length > 10) {
                    ...
                    $("#modalDialog .modal-body").html("单个标签长度不超过10个字符！");
                ...
                if (tagslist.length > 4) {
                    $("#modalDialog h4").html("请注意");
                    $("#modalDialog .modal-body").html("至多五个标签！");
                    $("#modalDialog .modal-footer").html("<button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">我知道了</button>");
                    $("#modalDialog").modal("show");
                }
            } else {
