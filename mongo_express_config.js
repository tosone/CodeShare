...
if (process.env.VCAP_SERVICES) {
    ...
    mongo = {
        ...
        port: 27017,
        ssl: false,
        url: 'mongodb://tosone:8541539655@127.0.0.1:27017/CodeShare',
        username: 'tosone',
    };
}
...
module.exports = {
    ...
    basicAuth: {
        username: process.env.ME_CONFIG_BASICAUTH_USERNAME || 'tosone',
        password: process.env.ME_CONFIG_BASICAUTH_PASSWORD || 'tosone',
    },
